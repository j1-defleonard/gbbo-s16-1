...
export function DraftClient() {
  const { players, teams, bakers, draftState, handleDraftPick } = useAppContext();
  ...
  const onBakerSelect = (bakerId: string) => {
    if (isUserTurn) {
      handleDraftPick(user.id, bakerId);
    }
  };
  ...
  if (isDraftComplete) {
    return (
        <div className="flex flex-col items-center justify-center h-full text-center space-y-4">
            ...
            <p className="text-muted-foreground">Your teams are set. Let the baking begin!</p>
            <Button asChild>
  ...
  return (
    <div className="container mx-auto p-4 space-y-8">
      <header className="text-center">
        <h1 className="text-4xl font-headline font-bold">The Great Fantasy Draft</h1>
